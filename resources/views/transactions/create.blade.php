...
@section('content')
    <x-common.page-breadcrumb :pageTitle="'Tambah Transaksi'" />

    <div class="mx-auto max-w-2xl">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <h3 class="mb-6 text-lg font-semibold text-gray-800 dark:text-white/90">Form Tambah Transaksi</h3>
                ...
                <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="wallet_id" required
                                ...
                                @foreach($wallets as $wallet)
                                    <option value="{{ $wallet->id }}" {{ old('wallet_id') == $wallet->id ? 'selected' : '' }}>{{ $wallet->name }} ({{ formatRupiah($wallet->balance) }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:ring-brand-500/10 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"

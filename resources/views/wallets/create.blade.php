...
@section('content')
    <x-common.page-breadcrumb :pageTitle="'Tambah Dompet'" />

    <div class="mx-auto max-w-2xl">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <h3 class="mb-6 text-lg font-semibold text-gray-800 dark:text-white/90">Form Tambah Dompet</h3>
            ...
            <form method="POST" action="{{ route('wallets.store') }}" x-data="{ loading: false }" @submit="loading = true">
                @csrf
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            ...
                            placeholder="Contoh: Kas, BCA, OVO" />
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Saldo Awal</label>

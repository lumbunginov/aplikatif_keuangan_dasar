...
@section('content')
    <x-common.page-breadcrumb :pageTitle="'Edit Kategori'" />

    <div class="mx-auto max-w-2xl">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <h3 class="mb-6 text-lg font-semibold text-gray-800 dark:text-white/90">Form Edit Kategori</h3>
            ...
            <form method="POST" action="{{ route('categories.update', $category) }}" x-data="{ loading: false }" @submit="loading = true">
                @csrf @method('PUT')
                <div class="space-y-5">
                    <div>
